            ...
            <div class="col-md-8 ms-auto me-auto">
                ...
                <form class="row g-3 needs-validation" method="post" action="" novalidate>
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="dg_name" id="validationCustom01" value="" required>
                    </div>
                    <div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="dg_age" id="validationCustom02" value="" required>
                    </div>
                    <div class="col-md-6">
                        <label for="validationCustom02" class="form-label">Nghề nghiệp</label>
                        <input type="text" class="form-control" name="dg_work" id="validationCustom02" value="" required>
                    </div>
                    <div class="col-md-6">
                        <label for="validationCustom02" class="form-label">Ngày cấp thẻ</label>
                        <input type="text" class="form-control" name="dg_capthe" id="validationCustom02" value="" required>
                    </div>
                    <div class="col-md-6">
                        <label for="validationCustom02" class="form-label">Ngày hết hạn</label>
                        <input type="text" class="form-control" name="dg_hethan" id="validationCustom02" value="" required>
                    </div>
                    <div class="col-md-6">
                        <label for="validationCustom02" class="form-label">Địa chỉ</label>
                        <input type="text" class="form-control" name="dg_diachi" id="validationCustom02" value="" required>
                    </div>
                    <div class="col-12">
